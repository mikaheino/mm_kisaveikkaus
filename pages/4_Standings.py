...
st.experimental_data_editor(dataset, height=550, use_container_width=True, num_rows="fixed", disabled=True)

dataset_overall=get_overall_status()

st.experimental_data_editor(dataset_overall, use_container_width=True, num_rows="fixed", disabled=True)
